...
from src.mluvenai.utils.calling_openai import call_openai
...
if api_key_inserted:
    ...
    cefr_level = st.radio("Select your CEFR level:", 
             options=["A1 (Absolute Beginner)", "A2 (Beginner)", "B1 (Intermediate)", "B2 (Upper Intermediate)", "C1 (Advanced)", "C2 (Proficient)"], 
             index=2, 
             help="Select your language proficiency level.")

    language_to_practice = st.selectbox("Select a language to practice:", 
